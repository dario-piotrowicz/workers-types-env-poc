...
declare type ExportedHandlerFetchHandler<
  Env extends { [str: string]: unknown } = import('@cloudflare/workers-types/base').Env,
...
declare type ExportedHandlerTailHandler<  Env extends { [str: string]: unknown } = import('@cloudflare/workers-types/base').Env> = (
  events: TraceItem[],
  env: Env,
  ctx: ExecutionContext
) => void | Promise<void>;
declare type ExportedHandlerTraceHandler<  Env extends { [str: string]: unknown } = import('@cloudflare/workers-types/base').Env> = (
  traces: TraceItem[],
  env: Env,
  ctx: ExecutionContext
) => void | Promise<void>;
declare type ExportedHandlerScheduledHandler<  Env extends { [str: string]: unknown } = import('@cloudflare/workers-types/base').Env> = (
  controller: ScheduledController,
  env: Env,
  ctx: ExecutionContext
) => void | Promise<void>;
declare type ExportedHandlerQueueHandler<  Env extends { [str: string]: unknown } = import('@cloudflare/workers-types/base').Env, Message = unknown> = (
  batch: MessageBatch<Message>,
  env: Env,
  ctx: ExecutionContext
) => void | Promise<void>;
declare type ExportedHandlerTestHandler<  Env extends { [str: string]: unknown } = import('@cloudflare/workers-types/base').Env> = (
...
declare type EmailExportedHandler<  Env extends { [str: string]: unknown } = import('@cloudflare/workers-types/base').Env> = (
