...
declare type ExportedHandlerFetchHandler<
  Env = import('@cloudflare/workers-types/base').Env,
...
declare type ExportedHandlerTailHandler<  Env = import('@cloudflare/workers-types/base').Env> = (
  events: TraceItem[],
  env: Env,
  ctx: ExecutionContext
) => void | Promise<void>;
declare type ExportedHandlerTraceHandler<  Env = import('@cloudflare/workers-types/base').Env> = (
  traces: TraceItem[],
  env: Env,
  ctx: ExecutionContext
) => void | Promise<void>;
declare type ExportedHandlerScheduledHandler<  Env = import('@cloudflare/workers-types/base').Env> = (
  controller: ScheduledController,
  env: Env,
  ctx: ExecutionContext
) => void | Promise<void>;
declare type ExportedHandlerQueueHandler<  Env = import('@cloudflare/workers-types/base').Env, Message = unknown> = (
  batch: MessageBatch<Message>,
  env: Env,
  ctx: ExecutionContext
) => void | Promise<void>;
declare type ExportedHandlerTestHandler<  Env = import('@cloudflare/workers-types/base').Env> = (
...
declare type EmailExportedHandler<  Env = import('@cloudflare/workers-types/base').Env> = (
